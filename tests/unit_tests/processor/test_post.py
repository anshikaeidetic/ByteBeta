...
from byte.processor.post import first, nop, random_one, temperature_softmax


def test_random_one() -> None:
...
def test_llm_verifier() -> None:
    ...
    from byte.processor.post import LlmVerifier
