...
import byte
from byte.manager.eviction.manager import EvictionBase
...
class TestEviction(unittest.TestCase):
    ...
    def test_lru_no_clean_size(self) -> None:
        datas = []
        ...
        eviction_base = byte.manager.eviction.EvictionBase(
