...
class BaseCacheLLM(metaclass=ABCMeta):
    """Base LLM proxy for ByteAI Cache.

    When you have enhanced llm without using the original llm api,
    ...
    Example:
        .. code-block:: python
            ...
            from byte.adapter import openai as cache_openai
    ...
    @classmethod
    def fill_base_args(cls, **kwargs) -> Any:
