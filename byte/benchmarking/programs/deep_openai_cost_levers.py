"""Thin entrypoint for the OpenAI cost-lever benchmark."""
...
PROGRAM_SPEC = BenchmarkProgramSpec(
    name="deep_openai_cost_levers",
    implementation_module="byte.benchmarking._program_impl.deep_openai_cost_levers",
    description="OpenAI cost-lever benchmark.",
)
