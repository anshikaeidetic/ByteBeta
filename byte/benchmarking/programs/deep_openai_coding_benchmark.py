"""Thin entrypoint for the OpenAI coding benchmark."""
...
PROGRAM_SPEC = BenchmarkProgramSpec(
    name="deep_openai_coding_benchmark",
    implementation_module="byte.benchmarking._program_impl.deep_openai_coding_benchmark",
    description="OpenAI coding workload benchmark.",
)
