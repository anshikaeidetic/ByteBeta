...
cohere = lazy_optional_module("cohere", package="cohere")
...
class CohereRerank(SimilarityEvaluation):
    ...
    Example:
        .. code-block:: python
            ...
            from byte.similarity_evaluation import CohereRerankEvaluation
    ...
    def __init__(self, model: str = "rerank-english-v2.0", api_key: str | None = None) -> None:
