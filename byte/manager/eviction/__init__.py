...
eviction_manager = LazyImport("eviction_manager", globals(), "byte.manager.eviction.manager")


def EvictionBase(name: str, **kwargs) -> Any:
    ...
    Example:
        .. code-block:: python
            ...
            from byte.manager import EvictionBase
