"""Utilities for generating legacy documentation reference pages."""
...
_conflict_name_dict = {"manager": ["eviction", "object_data", "scalar_data", "vector_data"]}
...
class DocGen:
    ...
    @staticmethod
    def title_bar(input_str: str) -> str:
        return "=" * len(input_str)

    @staticmethod
    def section_bar(input_str: str) -> str:
        return "-" * len(input_str)

    @staticmethod
    def get_filename(input_str: str) -> str:
        if input_str == "byte":
            return input_str
        ...
        for index, module in enumerate(modules):
            with open(
                ...
                t = func_temp.render(
                    {
                        "module_name": module,
                        "funcs": [(DocGen.get_filename(lib), lib) for lib in libs[index]],
                    }
                )
                f.write(t)
...
#     gen = DocGen(source_dir="/Users/derek/fubang/byte/byte", output_dir="/Users/derek/fubang/byte/docs/references")
#     gen.generate()
